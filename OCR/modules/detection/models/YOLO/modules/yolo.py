...
from .common import *
from .experimental import MixConv2d, CrossConv, C3, C3TR, GhostBottleneck, GhostConv
...
class Yolov5(nn.Module):
    def __init__(self, cfg='yolov5s.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
        ...
        self.model, self.save = parse_model_v5(deepcopy(self.yaml), ch=[ch])  # model, savelist
